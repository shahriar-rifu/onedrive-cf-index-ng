...
module.exports = {
  ...
  userPrincipalName: process.env.USER_PRINCIPLE_NAME || 'admin@searcheverything.onmicrosoft.com',
  ...
  footer:
    'Powered by <a href="https://shahriar.info.bd" target="_blank" rel="noopener noreferrer">onedrive-cf-index-ng</a>. Made with ❤ by Shahriar.',
  ...
  email: 'mailto:contact@shahriar.info.bd',
